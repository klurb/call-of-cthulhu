...
goog.addDependency("../advenjure/plugins/points.js", ['advenjure.plugins.points'], ['cljs.core', 'advenjure.utils']);
...
goog.addDependency("../cthulhu/rooms/start.js", ['cthulhu.rooms.start'], ['advenjure.items', 'cljs.core', 'advenjure.utils', 'advenjure.rooms', 'advenjure.change_rooms']);
goog.addDependency("../cthulhu/room_map.js", ['cthulhu.room_map'], ['advenjure.items', 'cljs.core', 'advenjure.utils', 'advenjure.rooms', 'cthulhu.rooms.start']);
goog.addDependency("../advenjure/plugins/map.js", ['advenjure.plugins.map'], ['advenjure.ui.output', 'cljs.core', 'advenjure.verb_map', 'advenjure.gettext.core', 'advenjure.hooks', 'advenjure.utils', 'clojure.string']);
goog.addDependency("../advenjure/plugins/dark.js", ['advenjure.plugins.dark'], ['advenjure.items', 'cljs.core', 'advenjure.verb_map', 'advenjure.gettext.core', 'advenjure.utils', 'advenjure.rooms', 'advenjure.change_rooms']);
goog.addDependency("../cthulhu/game.js", ['cthulhu.game'], ['advenjure.items', 'advenjure.plugins.points', 'cljs.core', 'cthulhu.room_map', 'advenjure.plugins.map', 'advenjure.verb_map', 'advenjure.game', 'advenjure.verbs', 'advenjure.utils', 'advenjure.plugins.dark']);
goog.addDependency("../cthulhu/core.js", ['cthulhu.core'], ['cthulhu.game', 'cljs.core']);
...
goog.addDependency("../figwheel/connect.js", ['figwheel.connect'], ['advenjure.ui.input', 'cljs.core', 'figwheel.client', 'figwheel.client.utils', 'cthulhu.core']);
